...
{  
  ...
  $stateProvider
    ...
    .state('forgot',  { url: "/forgot-password",  controller: 'LoginController',  controllerAs: 'lc', templateUrl: "views/reset1.html" })
    .state('reset',   { url: "/reset-password/:email/:key",  controller: 'LoginController',  controllerAs: 'lc', templateUrl: "views/reset2.html" })
  	.state('profile', { url: "/profile", controller: 'ProfileController', controllerAs: 'pc', 
